...
## Description
Java utility class with the values for the maximum deductible amounts of the [Swiss third pillar](https://www.bsv.admin.ch/de/die-dritte-saeule) in tied pension savings 3a.
...
The historic data is coming mainly from the PDF named "Chronologische Entwicklung der Gesetzgebung" that you can download on this [webpage](https://www.estv.admin.ch/de/fiskaleinnahmen-des-bundes).
